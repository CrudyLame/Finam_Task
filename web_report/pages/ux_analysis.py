...
def show_ux_analysis(conversations):
	...
	with tab1:
		...
		st.text_area("Ваши комментарии:", 
					placeholder="Введите здесь свои комментарии об анализе UX...", 
					height=100, 
					key="ux_comments")
	...
	with tab2:
		...
		st.info("Это место для ваших гипотез относительно анализа пользовательского опыта. Заполните по необходимости.")
		
		# Placeholder for hypotheses
		st.text_area("Ваши гипотезы:", 
					placeholder="Введите здесь свои гипотезы о пользовательском опыте...", 
					height=200, 
					key="ux_hypotheses")